...
def train_dqn(
    ...
    if save_model:
        torch.save(
            agent.policy_net.state_dict(), "dqn_obstacle_avoidance_weights_chu.pth"
        )
        print(
            "\n모델 가중치를 dqn_obstacle_avoidance_weights_chu.pth 에 저장하였습니다."
        )
...
if __name__ == "__main__":
    ...
    agent, rewards = train_dqn(num_episodes=5000, max_steps=200, render_interval=50)
